<template>
  <div class="py-10">
    <div class="max-w-7xl mx-auto sm:px-3 lg:px-1">
      <h1 class="text-blue-600 text-center text-2xl font-bold mb-8">
        Register account...
      </h1>
      <form class="max-w-md mx-auto">
        ...
        <button
          type="submit"
          class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
        >
          Login
        </button>
        <p class="text-lg mt-5 font-light text-black dark:text-black">
